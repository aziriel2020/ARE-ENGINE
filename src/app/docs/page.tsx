    ...
    <>
      ...
      <main style={{ maxWidth: '980px', margin: '0 auto', padding: '64px 24px' }}>
        <h1 style={{ fontFamily: 'Space Mono, monospace', fontSize: '36px', letterSpacing: '-0.02em', marginBottom: '12px' }}>
          ARE-E System Documentation
        </h1>
        <p style={{ fontSize: '15px', color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: '40px' }}>
          Core promise: submit Artist + Theme (plus optional deep direction), then receive a full production package designed for multilingual, cross-genre, and ensemble-aware generation workflows.
        </p>
        ...
        <section style={{ marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
            Flagship generation mode is designed around Gemini 3.1 Pro orchestration for high-depth reasoning and structured output planning.
          </p>
        </section>
