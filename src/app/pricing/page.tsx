      ...
      <main>
        <div style={{ padding: '80px 24px 0', textAlign: 'center', maxWidth: '740px', margin: '0 auto' }}>
          ...
          >
            ...
            <br />
            <span style={{ color: 'var(--accent)' }}>your production ambition.</span>
          </h1>
          <p style={{ fontSize: '15px', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
            Start with Artist + Theme, prove output quality, then scale to roster, studio, or enterprise pipelines.
          </p>
        </div>
